...
type message interface { //消息相关
	SendPrivateMessage(message entity.SendPrivateMessage) entity.PrivateMsg                     //该接口用于发送私聊消息。
	SendGroupMessage(message entity.SendGroupMessage) entity.GroupMsg                           //该接口用于发送群聊消息。
	SendMessage(message entity.SendMessage) entity.SendMessage                                  //该接口用于发送消息。
	GetMessage(messageId int32) entity.Msg                                                      //该接口用于获取消息。
	GetHistoryMessage(entity.MessageHistory) entity.MessageHistory                              //该接口用于获取历史消息。
	...
	SendGroupForwardMessage(forward entity.SendGroupForwardMessage) entity.Common               //该接口用于发送群聊合并转发。
	SendPrivateForwardMessage(forward entity.SendPrivateForwardMessage) entity.Common           //该接口用于发送私聊合并转发。
}
